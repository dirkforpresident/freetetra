...
const statRepeaters = computed(() => publicStatus.value?.repeaters ?? 0);
...
<template>
  <div class="admin-shell">
    <div class="container">
      ...
      <div class="stats">
        <div class="stat">
          <div class="stat-value">{{ statRepeaters }}</div>
      ...
      <div class="card">
        ...
        <div v-if="stations.length === 0" class="empty">{{ t("admin.empty.repeaters") }}</div>
